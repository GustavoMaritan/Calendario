...
$.fn.caledario = function (conteudo) {
    getTitulos(this, conteudo);
    getConteudo(this, conteudo);
};

function addTag(id, tag, classe) {
    return $(tag, {
        id: id,
        class: classe
    });
...
function getTitulos(content, conteudo) {
    ...
    var a3 = addTag("divTituloHorario", '<div>', 'divTituloMargConteudo');
...
function getConteudo(content, conteudo) {
    ...
    var b2 = addTag("divHorarios", "<div>", "divConteudo");
